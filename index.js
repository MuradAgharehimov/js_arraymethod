let results = [
  ...
  
    {
      ...
      order: {
        ...
        shipAddress: "Carrera 52 con Ave. Bolívar #65-98 LlanoLargo",
...
//   1) freight 1 dən kiçik olan sifarişləri console-a yazdır
  ...
  //   if (order.order.freight < 1) {
  //     console.log("ID:", order.order.id);
  //     console.log("customerId:", order.order.customerId);
  //     console.log("freight:", order.order.freight);
  //   }
  // });
    ...
    // results.forEach((order) => {
    // if (order.order.customerId === "ERNSH") {
    // ernsh++;
    //  }
    // });

    // console.log("customerID ERNSH olan: " + ernsh);
...
// results.sort((a, b) => a.order.employeeId - b.order.employeeId);

// results.forEach((order) => {
//   console.log("Order ID:", order.order.id, "EMP ID:", order.order.employeeId);
// });



     // 4) OrderDetailsi 3-dən çox olanları console-a yazdır
    ...
    // 5) İD-si 11075 olanı tap və yazdır. (find)

    // const x = results.find((order) => order.order.id === 11075);

    // if (x) {
    //   console.log("Order ID:", x.order.id);
    //   console.log("Customer ID:", x.order.customerId);
    
    // } else {
    //   console.log("ID'si 11075 olan yoxdur.");
    // }
